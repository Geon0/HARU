...
<body>
<div class="header_wrap top15" style="height:100px; padding-bottom:15px; margin-left: 166px ">
<nav class="navbar navbar-expand-lg" style="background-color: white" id="main-nav">
 ...
 <div class="container mb40">
      ...
      <input type="hidden" id="command" name="command"  value="teacher_profile">
        ...
        <!--    <form action="profile.do" method="post"> 
           <input type="hidden" name="command" value="teacher_profile">  -->
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="<%=member.getEmail() %>" id="example-text-input" name="email">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row" >
                <div class="col-md-12">
                    <div class="row">
                        <label for="example-text-input" class="col-2 col-form-label">오픈 채팅</label>
                        <div class="col-10">
                            <input class="form-control" type="text" value="<%=member.getOpenchat() %>" id="example-text-input" name="openchat">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" value="<%=member.getPhone() %>" id="example-text-input" name="phone">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row">
                        <label for="example-text-input" class="col-2 col-form-label">상태명</label>
                        <div class="col-10">
                            <textarea class="form-control" id="example-text-input" name="pmessage"><%=member.getPmessage() %></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="row">
                        <label for="example-text-input" class="col-2 col-form-label">경력사항</label>
                        <div class="col-10">
                            <textarea class="form-control" id="example-text-input" name="career"><%=member.getCareer() %></textarea>
                        </div>
                    </div>
                </div>
            </div>
