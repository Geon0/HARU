...
<body>
  ...
  <div class="board_table_detail" style="padding-left:350px;">
    ...
    <table class="table_deta" border= "1px solid rgb(170, 168, 168);">
          ...
          <tr>
              <th>내용</th>
              <td colspan="2"><textarea name="content" rows="15" cols="94" style="resize: none;">${dto.content }</textarea></td>
          </tr>
    </table>
        <div class="board_btn" style="padding: 20px 280px;"> 
          <button type="button" class="btn btn-outline-primary" style="outline: none; background-color:rgb(129, 129, 129); color:white;" onclick="location.href='board.do?command=updateform&bbs_no=${dto.bbs_no}'">수정</button>
          <button type="button" class="btn btn-outline-primary" style="outline: none;" onclick="location.href='board.do?command=delete&bbs_no=${dto.bbs_no}'">삭제</button>
